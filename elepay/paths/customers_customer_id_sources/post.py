...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = SourceReq


request_body_source_req = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsoncharsetutf8 = SourceDto
...
class BaseApi(api_client.Api):
    ...
    def _create_source_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_source_req.serialize(body, content_type)
...
class CreateSource(BaseApi):
    ...
    def create_source(
        ...
        return self._create_source_oapg(
            body=body,
