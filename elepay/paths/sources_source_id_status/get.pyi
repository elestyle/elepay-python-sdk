...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = SourceStatusDto
...
class BaseApi(api_client.Api):
    @typing.overload
    def _retrieve_source_status_oapg(
        self,
...
class RetrieveSourceStatus(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def retrieve_source_status(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def retrieve_source_status(
        ...
        return self._retrieve_source_status_oapg(
