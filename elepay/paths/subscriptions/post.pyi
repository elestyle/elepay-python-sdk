...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = SubscriptionReq


request_body_subscription_req = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsoncharsetutf8 = SubscriptionDto
...
class BaseApi(api_client.Api):
    ...
    def _create_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subscription_req.serialize(body, content_type)
