...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = TerminalReaderReq


request_body_terminal_reader_req = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsoncharsetutf8 = TerminalReaderDto
...
class BaseApi(api_client.Api):
    ...
    def _create_reader_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_terminal_reader_req.serialize(body, content_type)
...
class CreateReader(BaseApi):
    ...
    def create_reader(
        ...
        return self._create_reader_oapg(
            body=body,
