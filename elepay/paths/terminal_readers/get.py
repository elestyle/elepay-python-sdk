...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = TerminalReadersResponse
...
class ListReaders(BaseApi):
    ...
    def list_readers(
        ...
        return self._list_readers_oapg(
