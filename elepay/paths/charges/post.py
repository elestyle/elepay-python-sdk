...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = ChargeReq


request_body_charge_req = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsoncharsetutf8 = ChargeDto
...
class BaseApi(api_client.Api):
    ...
    def _create_charge_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_charge_req.serialize(body, content_type)
...
class CreateCharge(BaseApi):
    ...
    def create_charge(
        ...
        return self._create_charge_oapg(
            body=body,
