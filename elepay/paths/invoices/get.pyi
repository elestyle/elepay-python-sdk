...
class StatusSchema(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['InvoiceStatusType']:
            return InvoiceStatusType

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['InvoiceStatusType'], typing.List['InvoiceStatusType']],
    ...
    def __getitem__(self, i: int) -> 'InvoiceStatusType':
...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = InvoicesResponse
