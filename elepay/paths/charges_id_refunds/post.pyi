...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = RefundReq


request_body_refund_req = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsoncharsetutf8 = RefundDto
...
class BaseApi(api_client.Api):
    ...
    def _create_refund_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_refund_req.serialize(body, content_type)
