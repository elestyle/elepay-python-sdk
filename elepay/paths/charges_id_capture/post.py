...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = ChargeCaptureReq


request_body_charge_capture_req = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = ChargeDto
...
class BaseApi(api_client.Api):
    ...
    def _capture_charge_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_charge_capture_req.serialize(body, content_type)
...
class CaptureCharge(BaseApi):
    ...
    def capture_charge(
        ...
        return self._capture_charge_oapg(
            body=body,
