...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = CodeReq


request_body_code_req = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJsoncharsetutf8 = CodeDto
...
class BaseApi(api_client.Api):
    ...
    def _create_code_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_code_req.serialize(body, content_type)
