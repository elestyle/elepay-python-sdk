...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = InvoiceReq


request_body_invoice_req = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = InvoiceDto
...
class BaseApi(api_client.Api):
    ...
    def _update_invoice_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_invoice_req.serialize(body, content_type)
...
class UpdateInvoice(BaseApi):
    ...
    def update_invoice(
        ...
        return self._update_invoice_oapg(
            body=body,
