...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = CustomerReq


request_body_customer_req = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = CustomerDto
...
class BaseApi(api_client.Api):
    ...
    def _update_customer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_customer_req.serialize(body, content_type)
