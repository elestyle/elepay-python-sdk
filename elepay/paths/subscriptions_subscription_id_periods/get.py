...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = SubscriptionPeriodsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_subscription_periods_oapg(
        self,
...
class ListSubscriptionPeriods(BaseApi):
    ...
    def list_subscription_periods(
        ...
        return self._list_subscription_periods_oapg(
