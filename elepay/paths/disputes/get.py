...
# Query params
ChargeIdSchema = schemas.StrSchema
ModelFromSchema = schemas.Int64Schema
ToSchema = schemas.Int64Schema
DateFieldSchema = DisputeDateTimeType
StatusSchema = DisputeStatusType
...
SortSchema = DisputeDateTimeType
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'chargeId': typing.Union[ChargeIdSchema, str, ],
...
request_query_charge_id = api_client.QueryParameter(
    name="chargeId",
    style=api_client.ParameterStyle.FORM,
    schema=ChargeIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = DisputesResponse
...
class ListDisputes(BaseApi):
    ...
    def list_disputes(
        ...
        return self._list_disputes_oapg(
