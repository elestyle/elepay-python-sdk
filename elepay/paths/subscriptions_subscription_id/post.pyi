...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'subscriptionId': typing.Union[SubscriptionIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJsoncharsetutf8 = SubscriptionUpdateReq


request_body_subscription_update_req = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsoncharsetutf8 = SubscriptionDto
...
class BaseApi(api_client.Api):
    ...
    def _update_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subscription_update_req.serialize(body, content_type)
