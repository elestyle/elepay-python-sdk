...
from elepay.exceptions import (
    ApiTypeError,
    ApiValueError,
)
from elepay.configuration import (
    Configuration,
)
...
class Schema:
    ...
    def _validate_oapg(
        ...
        Make all property nullable, which mean NoneClass will be always validated successfully
