...
class DisputeDto(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def status() -> typing.Type['DisputeStatusType']:
                return DisputeStatusType
            resolvedTime = schemas.Int64Schema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'DisputeStatusType': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resolvedTime"]) -> MetaOapg.properties.resolvedTime: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "object", "chargeId", "liveMode", "amount", "currency", "metadata", "reason", "status", "resolvedTime", "createTime", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> typing.Union['DisputeStatusType', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resolvedTime"]) -> typing.Union[MetaOapg.properties.resolvedTime, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "object", "chargeId", "liveMode", "amount", "currency", "metadata", "reason", "status", "resolvedTime", "createTime", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        status: typing.Union['DisputeStatusType', schemas.Unset] = schemas.unset,
        resolvedTime: typing.Union[MetaOapg.properties.resolvedTime, decimal.Decimal, int, schemas.Unset] = schemas.unset,
