...
class DisputesResponse(
        ...
        class properties:
            ...
            class disputes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DisputeDto']:
                        return DisputeDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DisputeDto'], typing.List['DisputeDto']],
                ...
                def __getitem__(self, i: int) -> 'DisputeDto':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "disputes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "disputes", ], str]):
