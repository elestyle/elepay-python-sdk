...
class SubscriptionScheduleChargesResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class charges(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ChargeDto']:
                        return ChargeDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ChargeDto'], typing.List['ChargeDto']],
                ...
                def __getitem__(self, i: int) -> 'ChargeDto':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "charges", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "charges", ], str]):
