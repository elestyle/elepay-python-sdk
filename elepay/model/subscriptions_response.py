...
class SubscriptionsResponse(
        ...
        class properties:
            ...
            class subscriptions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SubscriptionDto']:
                        return SubscriptionDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SubscriptionDto'], typing.List['SubscriptionDto']],
                ...
                def __getitem__(self, i: int) -> 'SubscriptionDto':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "subscriptions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "subscriptions", ], str]):
