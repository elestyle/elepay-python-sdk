...
class SourceResponse(
        ...
        class properties:
            ...
            class sources(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SourceDto']:
                        return SourceDto
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SourceDto'], typing.List['SourceDto']],
                ...
                def __getitem__(self, i: int) -> 'SourceDto':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "sources", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "sources", ], str]):
